...
<head>
    ...
    <?php if (!strpos($_SERVER['SCRIPT_FILENAME'], 'index.php')  && !strpos($_SERVER['SCRIPT_FILENAME'], 'about_us.php')) : ?>
        <style>
            header {
                ...
                height: <?= strpos($_SERVER['SCRIPT_FILENAME'], 'home.php') ? 80 : 65 ?>vh;
            }
        </style>
    <?php else : ?>
        <style>
...
<body>
    ...
    <header>
        ...
        <?php if (!strpos($_SERVER['SCRIPT_FILENAME'], 'index.php')&&!strpos($_SERVER['SCRIPT_FILENAME'], 'contact_us.php')&&!strpos($_SERVER['SCRIPT_FILENAME'], 'about_us.php')) : ?>
